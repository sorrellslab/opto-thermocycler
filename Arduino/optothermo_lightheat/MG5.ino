...
const double firstLEDstim [7] = {0L, 0L, 1L, 0L, 1L, 1L, 0L};
const double secondLEDstim [7] = {0L, 0L, 1213000L, 0L, 1213000L, 0L, 0L};
const double thirdLEDstim [7] = {0L, 0L, 2413000L, 0L, 0L, 0L, 0L};
