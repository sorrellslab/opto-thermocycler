...
const long minIHI = 60000L; //minimum time before triggering another temperature increase
const double lowThresh = 23.2; //threshold for triggering the start of a stimulus
...
const double firstLEDstim [7] = {607000L, 0L, 1L, 1L, 1213000L, 1213000L, 1L};
const double secondLEDstim [7] = {0L, 0L, 0L, 0L, 0L, 0L, 0L};
...
// Variables:
int tempStimulus = 0; //increments each time the temperature increases
